from secp256k1.fe import Fe, fe_from_u64, fe_from_limbs, _fe_to_int
from secp256k1.field_limb import add_carry, sub_borrow, mul64_128, P0, P1, P2, P3
...
fn fe_mul(a: Fe, b: Fe) -> Fe:
    # --- DBG: Print inputs ---
    print("--- fe_mul start ---")
    dbg_array_u64("a.v", a.v)
    dbg_array_u64("b.v", b.v)
    ...
    dbg_array_u64("t (after schoolbook)", t)
    ...
    dbg_array_u64("r (after main reduction)", r)
    ...
    dbg_array_u64("out.v (before canonicalize loop)", out.v)
    ...
    dbg_array_u64("final out.v", out.v)
    print("--- fe_mul end ---")
    return out^
