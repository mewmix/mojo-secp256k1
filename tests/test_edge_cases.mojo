...
from secp256k1.sign import generator_point, point_double
...
fn main() raises:
    ...
    # Test that the generator point is not on a small subgroup
    var G = generator_point()
    var p2 = point_double(G)
    if p2.infinity:
        raise Error("2*G is the point at infinity")
